...
- **A `null` is a task, not a verdict.** Resolving one against a primary source is the highest-value contribution to this dataset. Current gaps: `phone_required` 43/69, `commercial_ok` 35/69, `card_required` 16/69.
