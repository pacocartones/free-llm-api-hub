...
- **A `null` is a task, not a verdict.** Resolving one against a primary source is the highest-value contribution to this dataset. Current gaps: `phone_required` 42/67, `commercial_ok` 35/67, `card_required` 22/67.
