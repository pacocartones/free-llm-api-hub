...
- **Sibling scope, kept separate:** free AI coding tools, and startup credit programs — valuable but volatile, so they'd live as clearly-separated sections or a sibling repo rather than diluting the core list.
